...
export const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-20 md:py-28 px-6 sm:px-8 border-b border-white/[0.08] bg-[#0A0A0A]">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-[#71717A]">{targetEmail}</div>
                    </div>
                  </div>
          ...
          <div className="lg:col-span-7">
            {submitted ? (
              <div className="p-8 rounded border border-[#10B981]/30 bg-[#0E0E0E] space-y-4 font-mono text-center">
                ...
                <div className="flex flex-wrap justify-center gap-3 pt-2">
                  <button
                    ...
                    className="px-4 py-2 bg-[#10B981] hover:bg-[#059669] text-white rounded text-xs font-semibold flex items-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-[#3B82F6] hover:bg-[#2563EB] text-white rounded text-xs font-semibold flex items-center gap-2"
                  >
              ...
              <form onSubmit={(e) => handleSend(e, sendMethod)} className="space-y-4 font-mono text-xs">
                ...
                {/* Method selector tab */}
                <div className="p-1 bg-[#121212] rounded border border-white/[0.08] flex gap-1">
                  <button
                    type="button"
                    onClick={() => setSendMethod('whatsapp')}
                    className={`flex-1 py-2 px-3 rounded flex items-center justify-center gap-2 text-xs transition-colors ${
                      sendMethod === 'whatsapp'
                  ...
                  >
                    <WhatsAppIcon className="w-3.5 h-3.5" />
                    <span>Send to WhatsApp (+91 8667760793)</span>
                  </button>
                  ...
                  >
                    <Mail className="w-3.5 h-3.5" />
                    <span>Send to Email ({targetEmail})</span>
                  </button>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-3 pt-1">
                  <button
                    type="button"
                    onClick={(e) => handleSend(e, 'whatsapp')}
                    className="px-5 py-3 rounded bg-[#10B981] hover:bg-[#059669] text-white font-semibold flex items-center gap-2 transition-all active:scale-95 shadow-md"
                  >
                  ...
                  <button
                    type="button"
                    onClick={(e) => handleSend(e, 'email')}
                    className="px-5 py-3 rounded bg-[#1A1A1A] hover:bg-[#242424] text-white border border-white/15 hover:border-[#3B82F6] font-semibold flex items-center gap-2 transition-all active:scale-95"
                  >
                    <Mail className="w-4 h-4 text-[#3B82F6]" />
