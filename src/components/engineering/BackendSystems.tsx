  ...
  const layers = [
    {
      ...
      tech: 'HTTP/2 · WebSockets · Browser Web Audio',
    ...
    },
    {
      ...
      tech: 'FastAPI Router · Next.js Server Handlers · Caddy',
    ...
    },
    {
      ...
      tech: 'OpenCV / dlib · Signal Energy Windows · Vector Match',
    ...
    },
    {
      ...
      tech: 'Gemini 2.5 Flash · ElevenLabs TTS · Web Audio',
    ...
    <section className="py-20 md:py-28 px-6 sm:px-8 border-b border-white/[0.08] bg-[#0A0A0A]">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-6 p-6 rounded border border-white/[0.08] bg-[#0E0E0E] space-y-4 font-mono">
            ...
            <div className="space-y-2">
              ...
              <div className="text-xs text-[#3B82F6] bg-[#141414] p-2 rounded border border-white/[0.04]">
