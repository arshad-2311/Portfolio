...
export const CompanionAIShowcase: React.FC<CompanionAIShowcaseProps> = ({
  ...
  return (
    <div id="project-companion-ai" className="border border-white/[0.08] bg-[#0E0E0E] rounded-lg p-5 sm:p-8 transition-all hover:border-white/20">
      ...
      <div className="py-6 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        <div className="lg:col-span-6 space-y-4">
          ...
          <div className="p-3 bg-[#121212] border border-white/[0.06] rounded text-xs font-mono text-[#A1A1AA] space-y-1">
            <div className="text-white font-medium flex items-center gap-2">
              <ShieldAlert className="w-3.5 h-3.5 text-[#3B82F6] flex-shrink-0" />
        ...
        <div className="lg:col-span-6 border border-white/[0.08] bg-[#0A0A0A] rounded p-3.5 sm:p-4 space-y-4 font-mono text-xs">
          
          <div className="flex flex-wrap items-center justify-between gap-1 border-b border-white/[0.06] pb-2 text-[10px] sm:text-[11px] text-[#71717A]">
            <div className="flex items-center gap-2 truncate">
              <Mic className="w-3 h-3 text-[#3B82F6] flex-shrink-0" />
              <span className="truncate">INTERVIEW_RESPONSE.WAV</span>
            </div>
            <span className="text-[9px] sm:text-[10px] text-[#52525B]">[SIGNAL ANALYZER]</span>
          </div>

          {/* Waveform Canvas Simulation */}
          <div className="p-3.5 sm:p-4 bg-[#111111] rounded border border-white/[0.06] space-y-3">
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              <span className="text-[10px] sm:text-[11px] text-[#71717A]">00:18 / 00:45</span>
            </div>

            {/* Fake Waveform Bars */}
            <div className="flex items-end gap-1 h-12 sm:h-14 pt-2">
            ...
            <div className="flex flex-wrap justify-between gap-1 text-[9px] sm:text-[10px] text-[#52525B] pt-1">
              <span>0.0s</span>
          ...
          {/* Signal Diagnostics Tabs (2 columns on mobile, 4 on sm+) */}
          ...
          {/* Signal Feedback Box */}
          <div className="p-3 bg-[#111111] rounded border border-white/[0.04] text-[10px] sm:text-[11px] text-[#A1A1AA] leading-relaxed">
            {activeSignal === 'pace' && (
              <div>
