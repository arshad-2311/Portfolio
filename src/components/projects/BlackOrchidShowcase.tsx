...
export const BlackOrchidShowcase: React.FC<BlackOrchidShowcaseProps> = ({
  ...
  return (
    <div id="project-black-orchid" className="border border-white/[0.08] bg-[#0E0E0E] rounded-lg p-6 sm:p-8 transition-all hover:border-white/20">
      ...
      <div className="py-6 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-6 border border-white/[0.08] bg-[#0A0A0A] rounded p-4 space-y-4">
          <div className="flex items-center justify-between border-b border-white/[0.06] pb-2 text-xs font-mono">
            ...
            <span className="text-[10px] text-[#52525B]">NEXT.JS APP ROUTER</span>
          </div>
            ...
            <div className="space-y-3 font-mono text-xs">
              <div className="flex items-center justify-between text-[11px] text-[#71717A]">
                <span className="flex items-center gap-1.5">
                  <Radio className="w-3 h-3 text-[#3B82F6] animate-pulse" />
              ...
              {/* Emitted WS Payload */}
              <div className="p-2.5 bg-[#111111] rounded text-[10px] text-[#A1A1AA] border border-white/[0.04]">
          ...
          {activeTab === 'schema' && (
            <pre className="p-3 bg-[#111111] rounded text-[11px] font-mono text-[#D4D4D8] overflow-x-auto border border-white/[0.04]">
{`model Table {
